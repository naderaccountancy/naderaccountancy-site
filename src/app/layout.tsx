...
export const metadata: Metadata = {
  title: {
    default: "Nader Accountancy | Tax Strategy for High Earners",
    template: "%s | Nader Accountancy",
  },
  description: "Sophisticated tax strategy for high-earning professionals, entrepreneurs, and business owners. Proactive planning, entity optimization, and wealth preservation. Licensed CPA with M.S. Taxation.",
  keywords: [
  ...
  openGraph: {
    ...
    title: "Nader Accountancy | Tax Strategy for High Earners",
    description: "Sophisticated tax strategy for high-earning professionals and business owners. Preserve more of what you've built.",
    images: [
      {
        url: "/og-image.jpg",
        width: 1200,
        height: 630,
        alt: "Nader Accountancy - Tax Strategy for High Earners",
      },
    ],
  },
  twitter: {
