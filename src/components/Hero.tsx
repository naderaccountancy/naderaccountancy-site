...
/* ===========================================
   ...
   Content Creator focused messaging
   =========================================== */
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 pt-52">
        <div className="max-w-3xl">
          ...
          <p className="animate-fade-in-up opacity-0 animation-delay-200 text-lg sm:text-xl text-gray-300 mb-10 leading-relaxed max-w-2xl">
            Tax strategy built for content creators, YouTubers, and online business owners. I handle the tax complexity so you can focus on what you do best—creating.
          </p>
          ...
          <div className="animate-fade-in-up opacity-0 animation-delay-400 mt-12 pt-12 border-t border-white/10">
            <p className="text-gray-400 text-sm mb-4">Trusted by content creators across the US</p>
            <div className="flex flex-wrap gap-6 items-center">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-white text-sm font-medium">Creator-Focused</span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-5 h-5 text-[var(--color-gold)]" fill="currentColor" viewBox="0 0 20 20">
                ...
                <span className="text-white text-sm font-medium">S-Corp Specialist</span>
              </div>
            </div>
            {/* Creator platforms */}
            <div className="flex items-center gap-2 mt-6">
              <span className="text-gray-400 text-sm">I work with creators on:</span>
              <span className="text-white text-sm font-medium">YouTube • TikTok • Twitch • Podcasts • Courses</span>
            </div>
          </div>
        </div>
      </div>
